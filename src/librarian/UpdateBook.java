...
public class UpdateBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Update Book Details");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(60, 70, 350, 60);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jISBN.getText().isEmpty() || jTitle.getText().isEmpty() || jAuthor.getText().isEmpty() || jQuantity.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"Please fill in all fields");
            return;
        }
        
        //check if quantity is number
        if(!jQuantity.getText().matches("\\d+")){
        ...
        String query = "UPDATE books SET "
                + "book_genre = '"+(String)jGenre.getSelectedItem()+"', "
                + "book_title = '"+jTitle.getText()+"', "
                + "book_author = '"+jAuthor.getText()+"', "
                + "book_quantity = '"+jQuantity.getText()+"' "
                + "WHERE book_isbn = '"+jISBN.getText()+"'";
    ...
    public javax.swing.JComboBox<String> jGenre;
    public javax.swing.JTextField jISBN;
